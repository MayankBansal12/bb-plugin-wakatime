...
type TooltipProps = {
  ...
  /** Formats each value row. Forwarded to ChartTooltipContent. */
  formatter?: ComponentProps<typeof ChartTooltipContent>["formatter"];
  /** Formats the tooltip heading. Forwarded to ChartTooltipContent. */
 ...
 */
function Tooltip({ variant, roundness, defaultIndex, cursor = true, formatter, labelFormatter }: TooltipProps) {
